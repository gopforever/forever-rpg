...
const CLASSES = {
  ...
  necromancer: {
    ...
    abilities: [
      ...
      { name: 'Animate Dead', description: 'Weave necromantic energies into a nearby corpse to reanimate it as an undead servant under your command, gaining a skeletal companion to fight for you.', manaCost: 120, castTime: 8000, recastTime: 30000, effect: { type: 'summon_pet', value: 1 } },
